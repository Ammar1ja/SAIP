export const PATENTS_JOURNEY_SECTION_IDS = [
  'guidance',
  'patent-checklist',
  'ip-clinics',
  'ip-search-engine',
...
export type PatentsJourneySectionId = (typeof PATENTS_JOURNEY_SECTION_IDS)[number];

export const PATENTS_JOURNEY_SECTIONS = {
  guidance: {
    title: 'Guidance',
    description:
...
export const PATENTS_JOURNEY_TOC_ITEMS = [
  {
    id: 'guidance',
    label: 'Guidance',
    subItems: [
