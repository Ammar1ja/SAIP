export const overviewHeader = {
  ...
  videoPoster: '/images/copyrights/overview.jpg',
};

export const overviewGuide = {
  guideTitle: 'Copyright guides',
  guideCards: [
    {
...
export const overviewStatistics = {
  statistics: [
    {
      label: 'Number of copyright applications in 2023',
      value: 4076,
    ...
    {
      label: 'Number of registered copyrights in 2023',
      value: 4011,
      chartType: 'line' as const,
      chartData: [
        { value: 900 },
