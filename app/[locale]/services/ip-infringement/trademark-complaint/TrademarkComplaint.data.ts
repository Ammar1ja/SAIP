export const TRADEMARK_COMPLAINT_STEPS = [
  {
    number: 1,
    title: 'Log in',
    icon: 'user',
  ...
  {
    number: 3,
    title: 'Start Trademark Infringement Application',
    icon: 'clipboard-plus',
    details: [
...
export const TRADEMARK_COMPLAINT_REQUIREMENTS = [
  'Application Filing',
  'Provide any relevant files related to the requested guidance (if available)',
];

export const TRADEMARK_COMPLAINT_SIDEBAR = {
