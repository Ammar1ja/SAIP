...
import { IPObservatoryEnforcementData } from '@/lib/drupal/services/ip-observatory-enforcement.service';
import { useTranslations } from 'next-intl';

interface IpEnforcementContentProps {
  data: IPObservatoryEnforcementData;
}

export default function IpEnforcementContentPage({ data }: IpEnforcementContentProps) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {tabData.statistics.map((stat, index) => (
            <StatisticsCard
              ...
              trend={stat.trend}
              chartType="line"
              chartData={data.sampleChartData}
